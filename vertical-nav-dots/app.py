...
# @app.callback(
#     Output("link1", "className"),
#     [Input("url", "hash")]
# )
# def update_navigation_active(hash):
#     if hash == "#home" or hash == "":
#         active_links = "nav-dot nav-dot-selected"
#     else:
#         active_links = "nav-dot"
#     return active_links

# @app.callback(
#     Output("link2", "className"),
#     [Input("url", "hash")]
# )
# def update_navigation_active(hash):
#     if hash == "#about":
